...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Compra.comprovante'
        db.delete_column('home_compra', 'comprovante')

        # Adding field 'Compra.pago'
        db.add_column('home_compra', 'pago',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Compra.comprovante'
        db.add_column('home_compra', 'comprovante',
                      self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'Compra.pago'
        db.delete_column('home_compra', 'pago')
